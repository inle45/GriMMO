...
import { initPlayer, persistPlayer, gainXP } from './lib/playerUtils'
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <span style={{
            ...
            border: '1px solid rgba(255,107,53,0.3)', fontWeight: 600,
          }}>ALPHA</span>
        </div>
        {player && (
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <span style={{ fontSize: 12, color: '#9E9EBE' }}>
              <span style={{ color: '#FFD700' }}>⚜</span> Niv.{player.level}
            </span>
            <div style={{
